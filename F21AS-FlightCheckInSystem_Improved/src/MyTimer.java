...
//    }
//
//    public static void flightDeparture(int departureTimeInSeconds, Queue<Passenger> passengerQueue, List<Flight> flightList) {
//        timer.schedule(new TimerTask() {
//            @Override
//            public void run() {
...
//                processPassengers(passengerQueue,flightList);
//            }
//        }, departureTimeInSeconds * 1000); // * 1000ms
//    }
//
//    private static void processPassengers(Queue<Passenger> passengerQueue,List<Flight> flightList) {
//        while (!passengerQueue.isEmpty()) {
//            CheckInDesk.generateEconomyDesk(passengerQueue, flightList);
