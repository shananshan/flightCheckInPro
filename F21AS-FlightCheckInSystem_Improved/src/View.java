...
//        countersPanel.add(new JLabel("Desk 1 (Economy):"));
        countersPanel.add(scrollPane1);
//        countersPanel.add(new JLabel("Desk 2 (Economy):"));
...
//    	
        String desk1Info = queueToString(checkInDesk1.getCurrentPassenger());
        String desk2Info = queueToString(checkInDesk2.getCurrentPassenger());
        String desk3Info = queueToString(checkInDesk3.getCurrentPassenger());
...
//    }
    private String queueToString(Passenger p) {
        StringBuilder sb = new StringBuilder();
